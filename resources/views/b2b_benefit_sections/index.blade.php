<x-layouts::app :title="__('B2B Benefit Sections')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Manage B2B benefit section.
                </p>
            </div>

            <a href="{{ route('b2b-benefit-sections.create') }}"
        ...
        {{-- Search --}}
        <div class="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <form action="{{ route('b2b-benefit-sections.index') }}"
                  method="GET"
                ...
                <input type="text"
                       ...
                       placeholder="Search B2B benefit section..."
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    ...
                    <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        @forelse($b2bBenefitSections as $section)
                            <tr class="transition hover:bg-neutral-50 dark:hover:bg-neutral-800/60">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('b2b-benefit-sections.show', $section->id) }}"
                                        ...
                                        <a href="{{ route('b2b-benefit-sections.edit', $section->id) }}"
                                        ...
                                        <form action="{{ route('b2b-benefit-sections.destroy', $section->id) }}"
                                              method="POST"
                                              class="inline-block"
                                              onsubmit="return confirm('Are you sure you want to delete this B2B benefit section?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-20 text-center">
                                    <h3 class="text-lg font-semibold text-neutral-800 dark:text-white">
                                        No B2B Benefit Section Found
                                    </h3>

                                    <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                                        Create your first B2B benefit section.
                                    </p>
