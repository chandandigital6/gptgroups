<x-layouts::app :title="__('Edit Company Overview')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Update company overview content, cards and images.
                </p>
            </div>
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <form action="{{ route('company-overviews.update', $companyOverview) }}"
                  method="POST"
                ...
                @include('company_overviews._form', [
                    ...
                    'buttonText' => 'Update Company Overview'
                ])
            </form>
        </div>
