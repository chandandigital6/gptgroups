<x-layouts::app :title="__('Business Vertical Sections')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Manage page-wise companies and business vertical cards.
                </p>
            </div>

            <a href="{{ route('business-vertical-sections.create') }}"
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(180px, 1fr)); gap:16px;">
            ...
            <div class="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                <div class="text-sm text-neutral-500 dark:text-neutral-400">Cards</div>
                <div class="mt-2 text-3xl font-bold text-black dark:text-white">
                    {{ $stats['cards'] ?? 0 }}
                </div>
            </div>
        ...
        {{-- Search --}}
        <div class="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <form action="{{ route('business-vertical-sections.index') }}"
                  method="GET"
                ...
                <select name="page_slug"
                    ...
                    @foreach(['home', 'about', 'services', 'companies', 'brands', 'network', 'careers', 'contact'] as $page)
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    ...
                    <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        @forelse($businessVerticalSections as $section)
                            <tr class="transition hover:bg-neutral-50 dark:hover:bg-neutral-800/60">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <a href="{{ route('business-vertical-sections.show', $section->id) }}"
                                        ...
                                        <a href="{{ route('business-vertical-sections.edit', $section->id) }}"
                                        ...
                                        <form action="{{ route('business-vertical-sections.destroy', $section->id) }}"
                                              method="POST"
                                              class="inline-block"
                                              onsubmit="return confirm('Are you sure you want to delete this business vertical section?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-20 text-center">
                                    <h3 class="text-lg font-semibold text-neutral-800 dark:text-white">
                                        No Business Vertical Section Found
                                    </h3>

                                    <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                                        Create your first business vertical section.
                                    </p>
