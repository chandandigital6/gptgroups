<x-layouts::app :title="__('Create Founder Section')">
    ...
    @php
        ...
        $formAction = $team
            ? route('founder-sections.store', $team)
            : route('founder-sections.store');
    @endphp
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Add founder/CEO section content, image, stats and button.
                </p>
            </div>
