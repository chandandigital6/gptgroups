...
@if ($errors->any())
    <div
        class="rounded-2xl border border-red-200 bg-red-50 px-5 py-4 text-sm text-red-700 dark:border-red-800 dark:bg-red-900/20 dark:text-red-300">
...
<div class="grid gap-5 md:grid-cols-2">
    <div>
        ...
        <input type="text" name="page_slug" value="{{ old('page_slug', $b2bProgramSection?->page_slug ?? 'services') }}"
    ...
    <div>
        ...
        <input type="number" name="sort_order" value="{{ old('sort_order', $b2bProgramSection?->sort_order ?? 0) }}"
            min="0"
            class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-900 outline-none transition focus:border-black dark:border-neutral-700 dark:bg-neutral-950 dark:text-white dark:focus:border-white">
    </div>
</div>
...
<div>
    ...
    <input type="text" name="label" value="{{ old('label', $b2bProgramSection?->label ?? 'B2B Program') }}"
        class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-900 outline-none transition focus:border-black dark:border-neutral-700 dark:bg-neutral-950 dark:text-white dark:focus:border-white">
</div>
...
<div>
    ...
    <input type="text" name="title" value="{{ old('title', $b2bProgramSection?->title ?? '') }}" required
        class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-900 outline-none transition focus:border-black dark:border-neutral-700 dark:bg-neutral-950 dark:text-white dark:focus:border-white">
</div>
...
<div class="rounded-2xl border border-neutral-200 bg-neutral-50 p-5 dark:border-neutral-700 dark:bg-neutral-950">
    ...
    @if (!empty($b2bProgramSection?->image))
        <div class="mb-4 h-72 overflow-hidden rounded-2xl bg-neutral-100 dark:bg-neutral-800">
            <img src="{{ asset('storage/' . $b2bProgramSection->image) }}" alt="{{ $b2bProgramSection->image_alt }}"
    ...
    <div class="grid gap-5 md:grid-cols-2">
        ...
        <div>
            ...
            <input type="text" name="image_alt" value="{{ old('image_alt', $b2bProgramSection?->image_alt ?? '') }}"
                class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-900 outline-none transition focus:border-black dark:border-neutral-700 dark:bg-neutral-950 dark:text-white dark:focus:border-white">
        </div>
    </div>
</div>
...
<div class="rounded-2xl border border-neutral-200 bg-neutral-50 p-5 dark:border-neutral-700 dark:bg-neutral-950">
    ...
    <div class="grid gap-5 md:grid-cols-2">
        ...
        <div>
            ...
            <textarea name="card_description" rows="3"
...
<div class="rounded-2xl border border-neutral-200 bg-neutral-50 p-5 dark:border-neutral-700 dark:bg-neutral-950">
    ...
    <div class="grid gap-5 md:grid-cols-2">
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <textarea name="feature_1_description" rows="3"
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <textarea name="feature_2_description" rows="3"
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <input type="text" name="feature_3_title"
                value="{{ old('feature_3_title', $b2bProgramSection?->feature_3_title ?? '') }}"
                class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm">
            ...
            <textarea name="feature_3_description" rows="3"
                class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm">{{ old('feature_3_description', $b2bProgramSection?->feature_3_description ?? '') }}</textarea>
        </div>
         ...
         <div class="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <input type="text" name="feature_4_title"
                value="{{ old('feature_4_title', $b2bProgramSection?->feature_4_title ?? '') }}"
                class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm">
            ...
            <textarea name="feature_4_description" rows="3"
                class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm">{{ old('feature_4_description', $b2bProgramSection?->feature_3_description ?? '') }}</textarea>
        </div>
    </div>
</div>

<div
    class="flex items-center gap-3 rounded-2xl border border-neutral-200 bg-neutral-50 p-5 dark:border-neutral-700 dark:bg-neutral-950">
