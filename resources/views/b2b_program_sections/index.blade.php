<x-layouts::app :title="__('B2B Program Sections')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">
                    B2B Program Sections
                </h1>

                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Manage B2B program content.
                </p>
            </div>

            <a href="{{ route('b2b-program-sections.create') }}"
        ...
        {{-- Search --}}
        <div class="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <form action="{{ route('b2b-program-sections.index') }}"
                  method="GET"
                ...
                <input type="text"
                       ...
                       placeholder="Search B2B program section..."
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                    ...
                    <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        @forelse($b2bProgramSections as $section)
                            <tr class="transition hover:bg-neutral-50 dark:hover:bg-neutral-800/60">
                                ...
                                <td class="px-6 py-4">
                                    <div class="min-w-0">
                                        ...
                                        @if(!empty($section->description_1))
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <a href="{{ route('b2b-program-sections.show', $section->id) }}"
                                        ...
                                        <a href="{{ route('b2b-program-sections.edit', $section->id) }}"
                                        ...
                                        <form action="{{ route('b2b-program-sections.destroy', $section->id) }}"
                                              method="POST"
                                              class="inline-block"
                                              onsubmit="return confirm('Are you sure you want to delete this B2B program section?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-20 text-center">
                                    <h3 class="text-lg font-semibold text-neutral-800 dark:text-white">
                                        No B2B Program Section Found
                                    </h3>

                                    <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                                        Create your first B2B program section.
                                    </p>
