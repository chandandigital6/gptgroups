<x-layouts::app :title="__('Edit Retail Outlet Section')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">
                    Edit Retail Outlet Section
                </h1>

                <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    Update retail outlet content, cards, button and images.
                </p>
            </div>
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <form action="{{ route('retail-outlet-sections.update', $retailOutletSection) }}"
                  method="POST"
                ...
                @include('retail_outlet_sections._form', [
                    'retailOutletSection' => $retailOutletSection,
                    'buttonText' => 'Update Retail Outlet Section'
                ])
            </form>
        </div>
