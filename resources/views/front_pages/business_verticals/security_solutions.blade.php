    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-12 lg:grid-cols-[1.05fr_.95fr]">
            <div>
                ...
                <p class="section-label mt-6">Security Solutions Division</p>

                <h1 class="mt-4 text-4xl font-black leading-tight text-slate-950 sm:text-5xl lg:text-7xl">
                    Integrated protection for people, property <span class="block text-gradient">and business operations.</span>
                </h1>

                <p class="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
                    GPT Group provides integrated security solutions for residential, commercial and industrial applications.
                </p>
        ...
        @php
            $strengths = [
                [
                    ...
                    'description' => 'Smart surveillance, intercom and controlled entry solutions for villas and apartments.',
                ],
                [
                    'title' => 'Commercial & Industrial',
                    'description' => 'Scalable security architecture for offices, warehouses, retail and industrial facilities.',
                ],
                [
                    'title' => 'Integrated Project Support',
                    'description' => 'Product supply, system planning, partner coordination and post-installation support.',
                ],
            ];
        @endphp
