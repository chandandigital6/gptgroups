        ...
        <div class="grid items-center gap-7 lg:grid-cols-[1.05fr_.95fr] lg:gap-10">
            ...
            <div>
                ...
                <h1 class="mt-3 text-3xl font-black leading-tight text-slate-950 sm:text-4xl lg:text-5xl">
                    Integrated protection for people, property
                ...
                <p class="mt-4 max-w-3xl text-base leading-7 text-slate-600 lg:text-[17px]">
                    GPT Group provides integrated security solutions for
            ...
            <div class="hero-card overflow-hidden p-3">
                <img
                    ...
                    alt="Security Solutions Division"
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        @php
            $services = [
                ...
                [
                    'title' => 'Video Intercom Solutions',
                    'items' => [
                        'Villa intercom',
                        'Apartment intercom',
        ...
        <div class="grid items-center gap-7 lg:grid-cols-[.8fr_1.2fr] lg:gap-10">
            ...
            <div class="flex h-full flex-col items-center justify-center text-center lg:px-6">
                ...
                <p class="mt-3 max-w-xl text-base leading-7 text-slate-600">
                    Explore trusted security and smart surveillance brands supported
                    through GPT Group’s distribution and market development network.
                </p>
            </div>
            ...
            @php
                $brands = [
                    [
                        ...
                        'description' => 'Video surveillance, access control, intercom and security management solutions.',
                    ],
                    [
                        'name' => 'EZVIZ',
                        'logo_names' => ['New Project (7)', 'ezviz'],
                        'website' => 'https://www.ezviz.com/',
                        'description' => 'Smart home cameras, video security and connected monitoring solutions.',
                    ],
                ];
            @endphp
        ...
        @php
            $strengths = [
                [
                    ...
                    'description' => 'Surveillance, intercom and smart entry solutions for villas and apartments.',
                ],
                [
                    'title' => 'Commercial & Industrial',
                    'description' => 'Scalable security architecture for offices, warehouses and industrial facilities.',
                ],
                [
                    'title' => 'Integrated Project Support',
                    'description' => 'System planning, product supply and post-installation coordination.',
                ],
            ];
        @endphp
