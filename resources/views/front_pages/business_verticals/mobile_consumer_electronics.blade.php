    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-7 lg:grid-cols-[1.05fr_.95fr] lg:gap-10">
            <div>
                ...
                <p class="section-label mt-4">Mobile & Consumer Electronics Division</p>
                ...
                <p class="mt-4 max-w-3xl text-base leading-7 text-slate-600 lg:text-[17px]">
                    GPT Group specializes in smartphones, mobile devices and accessories across retail and wholesale channels.
                </p>
...
<section id="solutions" class="bg-white py-10 sm:py-12 lg:py-14">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        @php
            $services = [['title' => 'Smartphone Distribution', 'items' => ['Retail and wholesale supply', 'Launch planning', 'Channel availability']], ['title' => 'Mobile Accessories', 'items' => ['Chargers and cables', 'Audio products', 'Protection accessories']], ['title' => 'Retail Network Support', 'items' => ['Product placement', 'Retail activation', 'Sales support']], ['title' => 'Wholesale Distribution', 'items' => ['Bulk supply', 'Dealer pricing support', 'Inventory coordination']], ['title' => 'Brand Management', 'items' => ['Market development', 'Campaign support', 'Partner coordination']]];
        @endphp
        ...
        <div class="grid gap-7 lg:grid-cols-[.8fr_1.2fr] lg:gap-10">
            ...
            <div>
                ...
                <p class="mt-3 text-base leading-7 text-slate-600">
                    Explore the technology brands supported through GPT Group’s
                    distribution, channel development and market support network.
                </p>
            </div>
            ...
            @php
                $brands = [
                    [
                        ...
                        'description' => 'Smartphones, tablets, accessories and connected consumer electronics.',
                    ],
                    [
                        'name' => 'Vivo',
                        'logo' => 'vivo',
                        'website' => 'https://www.vivo.com/en',
                        'description' => 'Smartphones and mobile technology focused on design, camera and performance.',
                    ],
                    [
                    ...
                    [
                        ...
                        'logo' => 'nothing',
                        'website' => 'https://in.nothing.tech/',
                        'description' => 'Modern smartphones, audio products and connected consumer technology.',
                    ],
                ];
            @endphp
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                @foreach ($brands as $brand)
                    @php
                        $logoCandidates = [
                            asset('assets/logo brands/' . $brand['logo'] . '.png'),
                            asset('assets/logo brands/' . $brand['logo'] . '.jpg'),
                            asset('assets/logo brands/' . $brand['logo'] . '.jpeg'),
                            asset('assets/logo brands/' . $brand['logo'] . '.webp'),
                        ];
                    @endphp
                    ...
                    >
                        {{-- Logo --}}
                        <div class="relative grid h-24 place-items-center overflow-hidden rounded-xl border border-slate-100 bg-white px-5">
                            <img
                                src="{{ $logoCandidates[0] }}"
                                alt="{{ $brand['name'] }} official logo"
                                class="brand-logo h-14 w-full object-contain transition duration-300 group-hover:scale-105"
                                data-candidates='@json($logoCandidates)'
                                data-index="0"
                                loading="lazy"
                            >

                            <span class="brand-logo-fallback hidden text-center text-lg font-black text-slate-800">
                                {{ $brand['name'] }}
                            </span>
                        </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid gap-7 lg:grid-cols-[.8fr_1.2fr] lg:gap-10">
            <div>
                ...
                <p class="mt-3 text-base leading-7 text-slate-600">
                    Brand availability and partnership scope may vary by market and product category.
                </p>
            </div>
                ...
                @foreach($brands as $brand)
                    <div class="soft-card p-4">
                        ...
                        <p class="mt-3 text-xs leading-5 text-slate-500">
                            Distribution, channel support and market development through GPT Group.
                        </p>
                    </div>
                @endforeach
            </div>
...
<section class="bg-white py-10 sm:py-12 lg:py-14">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        @php
            $strengths = [['title' => 'Distribution Strength', 'description' => 'Product sourcing, inventory planning and retail execution across Oman.'], ['title' => 'Retail Partner Network', 'description' => 'Strong relationships with retailers, dealers and resellers.'], ['title' => 'Market Reach', 'description' => 'Coverage through wholesale, retail, B2B and channel routes.']];
        @endphp
