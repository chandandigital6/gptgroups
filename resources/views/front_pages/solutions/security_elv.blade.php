    ...
    @php
        $capabilities = [
            [
                ...
                'description' => 'IP cameras, recording systems and intelligent monitoring technologies.',
            ],
            [
                'title' => 'Access Control',
                'description' => 'Secure entry management for offices, buildings and restricted locations.',
            ],
            [
                'title' => 'Video Door Phone',
                'description' => 'Visitor identification and communication solutions for homes and buildings.',
            ],
            [
                'title' => 'Parking Management',
                'description' => 'Vehicle access, barrier control and parking monitoring technologies.',
            ],
            [
                'title' => 'Professional Display',
                'description' => 'Commercial display systems for control rooms, retail and enterprise spaces.',
            ],
            [
                'title' => 'Video Management Software',
                'description' => 'Centralized monitoring, recording and security management platforms.',
            ],
        ];
        ...
        $brands = [
            [
                ...
                'description' => 'Video surveillance, access control, intercom, professional displays and security management technologies.',
                'initials' => 'HK',
            ],
            [
                'name' => 'EZVIZ',
                'logo' => asset('assets/logo brands/ezviz.png'),
                'description' => 'Residential cameras, smart doorbells and connected home security products.',
                'initials' => 'EZ',
            ],
            [
                'name' => 'LifeSmart',
        ...
        $strengths = [
            [
                ...
                'description' => 'Security technologies designed to work together as one connected ecosystem.',
            ],
            [
                'title' => 'Scalable Deployment',
                'description' => 'Solutions suitable for homes, businesses and large project environments.',
            ],
            [
                'title' => 'Project & Channel Support',
                'description' => 'Product guidance and supply support for partners, consultants and system integrators.',
            ],
        ];
    @endphp
    ...
    <main class="overflow-hidden bg-white text-slate-900">
        ...
        <section
            ...
            style="background-image:
                linear-gradient(90deg, rgba(2,6,23,.96) 0%, rgba(2,6,23,.82) 55%, rgba(2,6,23,.40) 100%),
                url('https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=1600&q=76');"
        >
            ...
            <div class="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl py-14 sm:py-16 lg:py-20">
                    ...
                    <h1 class="mt-4 max-w-3xl text-4xl font-black leading-[1.08] tracking-tight text-white sm:text-5xl lg:text-6xl">
                        Integrated protection for safer
                    ...
                    <p class="mt-5 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                        GPT Group delivers integrated security and ELV technologies for residential,
                        commercial, hospitality, retail, enterprise and project environments across Oman.
                    </p>
                    ...
                    <div class="grid items-center gap-7 lg:grid-cols-[1fr_auto]">
                        <div>
                            ...
                            <h2 class="mt-3 max-w-3xl text-3xl font-black tracking-tight sm:text-4xl lg:text-5xl">
                                Planning an integrated security or ELV project? Connect with GPT Group.
                            </h2>
                        </div>
