            ...
            <div class="grid items-center gap-10 lg:grid-cols-[1.04fr_.96fr]">
                <div>
                    <a href="{{ route('solutions.index') }}"
                        ...
                        All Solutions</a>
                    <p class="sol-label mt-6">Smart Home & IoT Solutions</p>
                    <h1 class="mt-5 text-4xl font-black leading-[1.08] text-slate-950 sm:text-5xl lg:text-6xl">Connected
                        living designed around
                        <span class="sol-gradient">comfort and control.</span>
                    </h1>
                    <p class="mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">GPT Group brings connected
                        automation technologies to Oman, helping homes and modern spaces improve convenience, security,
                ...
                <div class="sol-image"><img
                        src="https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&w=1600&q=88"
                        alt="Smart Home & IoT Solutions"
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                <article class="sol-card"><span class="sol-number">01</span>
                    <h3 class="mt-5 text-xl font-black text-slate-950">Home Automation</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Centralized control of connected devices and everyday
                        home functions.</p>
                </article>
                <article class="sol-card"><span class="sol-number">02</span>
                    <h3 class="mt-5 text-xl font-black text-slate-950">Smart Lighting</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Automated scenes, scheduling and remote lighting
                        control.</p>
                </article>
                <article class="sol-card"><span class="sol-number">03</span>
                    <h3 class="mt-5 text-xl font-black text-slate-950">Smart Locks</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Secure keyless access and intelligent door management.
                    </p>
                </article>
                <article class="sol-card"><span class="sol-number">04</span>
                    <h3 class="mt-5 text-xl font-black text-slate-950">Smart Sensors</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Motion, door, environmental and occupancy monitoring.
                    </p>
                </article>
                <article class="sol-card"><span class="sol-number">05</span>
                    <h3 class="mt-5 text-xl font-black text-slate-950">Smart Curtains</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Automated curtains controlled by scenes, schedules or
                        mobile devices.</p>
                </article>
                <article class="sol-card"><span class="sol-number">06</span>
                    <h3 class="mt-5 text-xl font-black text-slate-950">Smart Climate Control</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Connected air-conditioning and temperature management.
                    </p>
                </article>
                <article class="sol-card"><span class="sol-number">07</span>
                    <h3 class="mt-5 text-xl font-black text-slate-950">Smart Energy Management</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Monitoring and automation designed to improve energy
                        efficiency.</p>
                </article>
            </div>
        </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto mt-10 grid max-w-5xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
                <article class="brand-card">
                    <div class="brand-logo"><img src="{{ asset('assets/logo brands/life smart.png') }}" alt="LifeSmart logo"
                            loading="lazy"></div>
                    <div class="flex flex-1 flex-col p-2 pt-5">
                        <h3 class="text-xl font-black text-slate-950">LifeSmart</h3>
                        <p class="mt-3 flex-1 text-sm leading-7 text-slate-600">Smart home automation, lighting, sensors,
                            climate control and intelligent living products.</p>
                    </div>
                </article>
            </div>
        </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid gap-5 md:grid-cols-3">
                <article class="sol-card">
                    ...
                    <h3 class="mt-4 text-xl font-black text-slate-950">Unified Smart Control</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Manage multiple devices and smart functions from one
                        connected interface.</p>
                </article>
                <article class="sol-card">
                    <p class="sol-gradient text-4xl font-black">02</p>
                    <h3 class="mt-4 text-xl font-black text-slate-950">Comfort & Convenience</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Automated routines designed around everyday lifestyles.
                    </p>
                </article>
                <article class="sol-card">
                    <p class="sol-gradient text-4xl font-black">03</p>
                    <h3 class="mt-4 text-xl font-black text-slate-950">Energy Awareness</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-600">Smart monitoring and control for more efficient spaces.
                    </p>
                </article>
            </div>
        </div>
            ...
            <div
                ...
                <div class="grid items-center gap-8 lg:grid-cols-[1fr_auto]">
                    <div>
                        ...
                        <h2 class="mt-4 max-w-3xl text-3xl font-black sm:text-4xl lg:text-5xl">Create a smarter home or
                            connected space with GPT Group’s IoT solutions.</h2>
