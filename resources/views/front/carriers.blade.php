...
@section('content')
    <section class="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div class="containerx relative py-32">
            ...
            <h1 class="mt-5 text-5xl md:text-7xl font-black">Careers</h1>
            <p class="mt-6 max-w-2xl text-xl text-slate-200">
                Join GPT Group. Premium sections for a modern business website
                presentation.
            </p>
        </div>
    </section>
    <section class="section">
        <div class="containerx grid lg:grid-cols-3 gap-6">
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Sales Executive</h3>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Warehouse Coordinator</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Retail Trainer</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Digital Marketing</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">B2B Manager</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Customer Support</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
