...
@section('content')
    <section class="relative overflow-hidden">
        ...
        <div class="containerx relative grid lg:grid-cols-2 gap-12 items-center py-28">
            <div>
                <p class="inline-flex rounded-full bg-blue-50 text-blue-700 font-black px-5 py-2">
                    Product Category
                </p>
                <h1 class="mt-7 text-5xl md:text-7xl font-black leading-tight">
                    Samsung Accessories
                </h1>
                <p class="mt-6 text-xl text-slate-600 leading-8">
                    Covers, chargers, audio and essential add-ons. Designed as a
                    separate product detail page with hero, specifications, partner
                    benefits, gallery and enquiry CTA.
                </p>
                <div class="mt-8 flex gap-4">
                    <a class="btn-primary" href="../pages/contact.html">Ask For Stock</a><a class="btn-light"
                        href="../pages/brands.html">All Brands</a>
                </div>
            </div>
            <img class="rounded-[44px] h-[560px] w-full object-cover shadow-2xl"
                src="https://images.unsplash.com/photo-1583394838336-acd977736f90?auto=format&fit=crop&w=1400&q=80" />
        </div>
    </section>
    <section class="section bg-white">
        <div class="containerx">
            <div class="text-center max-w-3xl mx-auto">
                <h2 class="text-5xl font-black">Category Highlights</h2>
                <p class="mt-5 text-slate-600 text-lg">
                    A modern product page structure suitable for inventory, upcoming
                    launches and retail partner promotions.
                </p>
            </div>
            <div class="mt-12 grid md:grid-cols-3 gap-6">
                <div class="premium-card rounded-[34px] p-8 bg-slate-50">
                    <h3 class="text-2xl font-black">Market Demand</h3>
                    <p class="mt-3 text-slate-600 leading-7">
                        High visibility products for retail counters and B2B requirements.
                    </p>
                </div>
                <div class="premium-card rounded-[34px] p-8 bg-slate-50">
                    <h3 class="text-2xl font-black">Partner Support</h3>
                    <p class="mt-3 text-slate-600 leading-7">
                        Training, promotional material and launch campaign support.
                    </p>
                </div>
                <div class="premium-card rounded-[34px] p-8 bg-slate-50">
                    <h3 class="text-2xl font-black">Supply Chain</h3>
                    <p class="mt-3 text-slate-600 leading-7">
                        Warehouse support, stock planning and order management.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="containerx grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <p class="mt-6 text-lg text-slate-600 leading-8">
                    Use this page to show product banners, key features, SKU groups,
                    model highlights, offer banners, warranty details and enquiry forms.
                </p>
                <ul class="mt-8 grid gap-4 text-slate-700 font-semibold">
                    <li>✓ Model-wise listing section</li>
                    <li>✓ Retail partner banner area</li>
                    <li>✓ B2B enquiry CTA</li>
                    <li>✓ Promotional launch support section</li>
                </ul>
            </div>
        </div>
    </section>
    <section class="section bg-slate-950 text-white">
        <div class="containerx text-center">
            ...
            <p class="mt-5 text-slate-300 text-lg">
                Connect with GPT Group for stock, launch support and partner programs.
            </p>
            <a href="../pages/contact.html" class="btn-light mt-8">Contact Sales Team</a>
        </div>
    </section>
