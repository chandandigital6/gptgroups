...
@section('content')
    <section class="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div class="containerx relative py-32">
            ...
            <h1 class="mt-5 text-5xl md:text-7xl font-black">News & Updates</h1>
            <p class="mt-6 max-w-2xl text-xl text-slate-200">
                Offers, launches and events. Premium sections for a modern business
    ...
    <section class="section">
        <div class="containerx grid lg:grid-cols-3 gap-6">
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Latest Offers</h3>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">New Product Launch</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Retail Events</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Partner Training</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
