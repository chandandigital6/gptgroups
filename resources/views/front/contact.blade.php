...
@section('content')
    <section class="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div class="containerx relative py-32">
            ...
            <h1 class="mt-5 text-5xl md:text-7xl font-black">Contact GPT Group</h1>
            <p class="mt-6 max-w-2xl text-xl text-slate-200">
                Office, map and enquiry. Premium sections for a modern business
                website presentation.
            </p>
        </div>
    </section>
    <section class="section">
        <div class="containerx grid lg:grid-cols-3 gap-6">
            <div class="premium-card bg-white rounded-[34px] p-8">
                <div class="w-14 h-14 rounded-2xl bg-blue-50 text-blue-700 grid place-items-center font-black">
                    ✓
                </div>
                <h3 class="mt-6 text-2xl font-black">Office Address</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            </div>
            <div class="premium-card bg-white rounded-[34px] p-8">
                <div class="w-14 h-14 rounded-2xl bg-blue-50 text-blue-700 grid place-items-center font-black">
                ...
                <h3 class="mt-6 text-2xl font-black">Google Map</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Phone / Email</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
            ...
            <div class="premium-card bg-white rounded-[34px] p-8">
                ...
                <h3 class="mt-6 text-2xl font-black">Contact Form</h3>
                <p class="mt-3 text-slate-600 leading-7">
                    Detailed section designed for GPT Group business content, partner
                    trust, retail growth and professional presentation.
                </p>
        ...
        <div class="containerx grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-5xl font-black">
                    Built for brand growth and partner success.
                </h2>
                <p class="mt-6 text-lg text-slate-600 leading-8">
                    GPT Group combines leadership experience, market insight,
                    operational execution, partner support and demand generation to
                    support global brands in Oman and GCC markets.
                </p>
                <div class="mt-8 grid sm:grid-cols-2 gap-5">
                    <div class="rounded-3xl bg-slate-50 p-6">
                        <b>Premium Positioning</b>
                        <p class="text-slate-600 mt-2">
                            Modern visual identity with corporate trust.
                        </p>
                    </div>
                    <div class="rounded-3xl bg-slate-50 p-6">
                        <b>Scalable Layout</b>
                        <p class="text-slate-600 mt-2">
                            Ready for banners, products, news and teams.
                        </p>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-5">
                <img class="rounded-[32px] h-72 object-cover"
                    ...
                    class="rounded-[32px] h-72 object-cover mt-10"
                    src="https://images.unsplash.com/photo-1494412519320-aa613dfb7738?auto=format&fit=crop&w=1200&q=80" />
            </div>
        </div>
    </section>
    <section class="section">
        <div class="containerx grid lg:grid-cols-2 gap-8">
            <div class="bg-white rounded-[34px] p-8 premium-card">
                <h3 class="text-3xl font-black">Send Enquiry</h3>
                <div class="mt-6 grid gap-4">
                    <input class="rounded-2xl border p-4" placeholder="Name" /><input class="rounded-2xl border p-4"
                        placeholder="Email" /><input class="rounded-2xl border p-4" placeholder="Phone" />
                    <textarea class="rounded-2xl border p-4 h-36" placeholder="Message"></textarea
            ><button class="btn-primary justify-center">Submit</button>
          </div>
        </div>
        <div class="bg-slate-950 text-white rounded-[34px] p-8">
          <h3 class="text-3xl font-black">Contact Details</h3>
          <p class="mt-5 text-slate-300 leading-8">
            Office: Muscat, Sultanate of Oman<br />Phone: +968 2450-1533<br />Email:
            info@gptgroups.com<br />Partner Email: xxx@gptgroups.com
          </p>
          <div
            class="mt-8 h-72 rounded-3xl bg-white/10 grid place-items-center text-slate-300"
          >
    ...
    <section class="section bg-white">
      <div class="containerx">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="relative">
            <img
              class="rounded-[44px] h-[560px] w-full object-cover shadow-2xl"
    ...
    <section class="section bg-slate-950 text-white overflow-hidden">
      <div class="containerx grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <a class="btn-light mt-8" href="../pages/retail-outlets.html"
            >View Retail Outlet Page</a
          >
        </div>
        <div class="grid grid-cols-2 gap-5">
          <img
            class="rounded-[32px] h-72 w-full object-cover"
            src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=1200&q=80"
            alt="retail outlet"
          />
          <img
            class="rounded-[32px] h-72 w-full object-cover mt-12"
    ...
    <section class="section">
      <div class="containerx">
        ...
        <div class="mt-10 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          <div
            class="rounded-3xl bg-white premium-card p-6 text-center font-black text-slate-700"
          >
            Samsung
          </div>
          <div
    ...
    <section class="section">
      <div class="containerx grid lg:grid-cols-2 gap-10">
        <div>
          ...
          <a class="btn-primary mt-8" href="../pages/contact.html"
            >Ask More Questions</a
          >
        </div>
    ...
    <section class="section bg-white">
      <div class="containerx grid lg:grid-cols-2 gap-10 items-stretch">
        <div
          class="rounded-[44px] bg-gradient-to-br from-blue-700 to-cyan-500 text-white p-10 md:p-14"
        >
          ...
          <div class="mt-8 flex flex-wrap gap-4">
            <a class="btn-light" href="../pages/contact.html">Partner Enquiry</a
            ><a class="btn-primary bg-slate-950" href="../pages/brands.html"
              >Explore Products</a
            >
          </div>
        </div>
        <div class="rounded-[44px] bg-slate-950 text-white p-10 md:p-14">
          ...
          <form class="mt-7 grid gap-4">
            ...
            />
            <select
              class="rounded-2xl border border-white/10 bg-white/10 px-5 py-4 text-slate-300"
            >
            ...
            <textarea
              class="rounded-2xl border border-white/10 bg-white/10 px-5 py-4 h-28 text-white placeholder:text-slate-400"
              placeholder="Message"
            ></textarea>
