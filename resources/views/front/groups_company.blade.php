            ...
            <div class="mx-auto max-w-3xl text-center">
                <span
                    ...
                    <span class="relative flex h-2.5 w-2.5">
                        <span
                            class="absolute inline-flex h-full w-full animate-ping rounded-full bg-blue-500 opacity-40"></span>
                ...
                <div class="grid lg:grid-cols-[.9fr_1.1fr]">
                    ...
                    <div class="relative min-h-[380px] overflow-hidden bg-slate-950 sm:min-h-[440px] lg:min-h-[650px]">
                        ...
                        <div class="absolute inset-x-0 bottom-0 p-5 sm:p-7">
                            <div
                                class="rounded-2xl border border-white/15 bg-slate-950/65 p-5 text-white shadow-2xl backdrop-blur-md sm:p-6">
                                ...
                                <div class="mt-5 grid grid-cols-3 gap-2">
                                    <div class="rounded-xl border border-white/10 bg-white/10 p-3">
                                        ...
                                        <p class="mt-1 text-[9px] font-bold uppercase tracking-wide text-slate-300">Core
                                            Markets</p>
                                    </div>
                                    <div class="rounded-xl border border-white/10 bg-white/10 p-3">
                                        <p class="text-lg font-black">B2B</p>
                                        <p class="mt-1 text-[9px] font-bold uppercase tracking-wide text-slate-300">Channel
                                            Focus</p>
                                    </div>
                                    <div class="rounded-xl border border-white/10 bg-white/10 p-3">
                                        <p class="text-lg font-black">360°</p>
                                        <p class="mt-1 text-[9px] font-bold uppercase tracking-wide text-slate-300">Support
                                            Model</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="relative flex flex-col justify-center px-5 py-8 sm:px-8 sm:py-10 lg:px-10 xl:px-12">
                        <div
                            class="pointer-events-none absolute right-0 top-0 h-44 w-44 rounded-bl-[7rem] bg-gradient-to-br from-blue-50 to-cyan-50">
                        </div>
                        ...
                        <div class="relative">
                            <div
                                ...
                                <img src="https://swastikatelecom.com/wp-content/uploads/2026/03/Logo-Final-350x97-1.png"
                                    alt="Swastika Telecom logo" class="h-auto w-[280px] max-w-full object-contain"
                                    loading="lazy">
                            </div>
                            ...
                            <div class="mt-6 grid gap-3 sm:grid-cols-2">
                                @foreach ([['Global Sourcing', 'Reliable product access and supplier coordination.'], ['Channel Development', 'Dealer, reseller and retail network expansion.'], ['Operational Support', 'Planning, fulfilment, training and after-sales coordination.'], ['Market Expansion', 'New categories, territories and growth opportunities.']] as [$title, $description])
                                    <div
                                        class="rounded-2xl border border-slate-200 bg-slate-50/80 p-4 transition hover:-translate-y-0.5 hover:border-blue-200 hover:bg-blue-50/60">
                                        <span
                                            class="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-blue-700 to-cyan-500 text-xs font-black text-white">
                            ...
                            <div
                                class="mt-6 rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50 via-white to-cyan-50 p-5">
...
========================================================= --}}
    ...
    <section id="group-companies" class="relative overflow-hidden bg-slate-50 py-10 sm:py-12 lg:py-14">
        ...
        <div class="pointer-events-none absolute -left-24 top-20 h-72 w-72 rounded-full bg-blue-100/60 blur-3xl">
        </div>

        <div class="pointer-events-none absolute -right-24 bottom-20 h-72 w-72 rounded-full bg-cyan-100/50 blur-3xl">
        </div>
        ...
        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto max-w-3xl text-center">
                ...
                <p
                    ...
                    <span class="h-0.5 w-8 rounded-full bg-gradient-to-r from-blue-700 to-cyan-500">
                    </span>

                    Our Companies

                    <span class="h-0.5 w-8 rounded-full bg-gradient-to-r from-cyan-500 to-blue-700">
                    </span>
                </p>
                        ...
                        <div class="grid items-stretch lg:grid-cols-2">
                            ...
                            {{ $imageOnLeft ? 'lg:order-1' : 'lg:order-2' }}">
                                ...
                                @if (filled($company['logo']))
                                    <div
                                        class="absolute left-5 bottom-24 rounded-2xl border border-white/30 bg-white/95 px-5 py-4 shadow-xl backdrop-blur-md sm:left-6">
                                        <img src="{{ $company['logo'] }}" alt="{{ $company['name'] }} logo"
                                            class="max-h-14 w-auto max-w-[210px] object-contain" loading="lazy"
                                ...
                                <div class="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                                    ...
                                    <p class="text-[10px] font-black uppercase tracking-[0.18em] text-cyan-300 sm:text-xs">
                                        GPT Group Company
                                    </p>
                            ...
                            {{ $imageOnLeft ? 'lg:order-2' : 'lg:order-1' }}">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="mt-4 flex items-center gap-2">
                                        ...
                                        <span class="h-1 w-12 rounded-full bg-gradient-to-r from-blue-700 to-cyan-500">
                                        </span>
                                    ...
                                    @else
                                        <div class="mt-6">
                                            <span class="inline-flex items-center gap-2 text-xs font-black text-blue-700">
